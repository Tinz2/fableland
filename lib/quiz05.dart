...
class _QuizPageState extends State<quiz05> {
  List<Map<String, dynamic>> questions = [
    {
      'question': 'ขยะอิเล็กทรอนิกส์คืออะไร?',
      'options': [
        'ขยะที่เกิดจากอุปกรณ์อิเล็กทรอนิกส์หมดอายุ',
        'ขยะจากการทิ้งขวดพลาสติก',
        'ขยะจากการทิ้งอาหารเหลือ',
        'ขยะจากการตัดต้นไม้'
      ],
      'answer': 'ขยะที่เกิดจากอุปกรณ์อิเล็กทรอนิกส์หมดอายุ',
    },
    {
      'question':
          'สารเคมีใดในขยะอิเล็กทรอนิกส์ที่อาจเป็นอันตรายต่อสิ่งแวดล้อมมากที่สุด?',
      'options': ['ทองคำ', 'ตะกั่ว', 'เงิน', 'ทองแดง'],
      'answer': 'ตะกั่ว',
    },
    {
